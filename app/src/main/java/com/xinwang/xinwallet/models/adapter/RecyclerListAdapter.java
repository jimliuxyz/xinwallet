...
public class RecyclerListAdapter extends RecyclerView.Adapter<RecyclerListAdapter.ItemViewHolder>
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listitem_currency_order_setting, parent, false);
    ...
    public void onBindViewHolder(final ItemViewHolder holder, int position) {
        holder.currencyName.setText(mItems.get(position));
        holder.currencyEnName.setText(mItems.get(position));
    ...
    public static class ItemViewHolder extends RecyclerView.ViewHolder implements
        ...
        final TextView currencyEnName, currencyName;
        final ImageView currencyIcon;
